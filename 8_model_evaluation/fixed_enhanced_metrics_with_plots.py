# fixed_enhanced_metrics_with_plots.py
import pandas as pd
import numpy as np
import joblib
import os
...
class FixedEnhancedMetricsVisualizer:
    """
    Fixed version that creates comprehensive plots without radar chart issues.
    """
    
    def __init__(self):
        self.results = {}
        self.plots_dir = "fixed_enhanced_metrics_plots"
...
def main():
    visualizer = FixedEnhancedMetricsVisualizer()
