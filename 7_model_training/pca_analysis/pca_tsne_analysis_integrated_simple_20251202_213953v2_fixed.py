#!/usr/bin/env python3
"""
COMPREHENSIVE PCA & t-SNE DIMENSIONALITY REDUCTION ANALYSIS - FIXED VERSION
...
# ============================================================================
# 5. t-SNE ANALYSIS - FIXED VERSION
# ============================================================================

print("\n" + "="*80)
print("5. t-SNE DIMENSIONALITY REDUCTION - FIXED")
print("="*80)
...
for perplexity in perplexities:
    ...
    # Run t-SNE - FIXED: using max_iter instead of n_iter
    try:
...
# ============================================================================
# 8. COMPREHENSIVE VISUALIZATIONS - SIMPLIFIED BUT COMPLETE
# ============================================================================
...
ax.set_yticks(y_pos)
ax.set_yticklabels([feature_cols[i] for i in top_indices], fontsize=8)
...
ax.set_yticks(y_pos)
ax.set_yticklabels([feature_cols[i] for i in top_indices_var], fontsize=8)
...
for i, idx in enumerate(top_indices, 1):
    summary_text += f"  {i}. {feature_cols[idx][:50]}: {pca.components_[0, idx]:.4f}\n"
...
summary = {
    'dataset': {
        ...
        'filtered_shape': list(df_filtered.shape),
    ...
    'pca': {
        ...
        'optimal_components': {str(k): v for k, v in optimal_components.items()},
...
# ============================================================================
# 10. FINAL OUTPUT AND NEXT STEPS
# ============================================================================

print("\n" + "="*80)
print("9. ANALYSIS COMPLETE - NEXT STEPS")
print("="*80)
